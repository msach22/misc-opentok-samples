...
*/
(function(d){d.OT||(d.OT={});OT.properties={version:"v2.2.5",build:"d52c9a1",debug:"<%= @debug %>",websiteURL:"<%= @website_url %>",cdnURL:"<%= @cdn_url %>",loggingURL:"<%= @logging_url %>",apiURL:"<%= @api_url %>",messagingProtocol:"wss",messagingPort:443,supportSSL:"<%= @support_ssl %>",cdnURLSSL:"<%= @ssl_widget_url %>",loggingURLSSL:"<%= @logging_url_ssl %>",
